...
public class ServerThreadCollection {
	...
	private static HashMap<String, ServerClientTogether> hm = new HashMap<String, ServerClientTogether>();
	
	/**
	 * 添加服务器端与客户端通信的线程集合的方法
	 * @param Name 用户名
	 * @param serverClientTogether 服务器端与客户端通信的线程
	 */
	public static void addServerConnectClientThreadCollection(String Name, ServerClientTogether serverClientTogether){
		hm.put(Name, serverClientTogether);
	}
	 ...
	 */
	public static ServerClientTogether getServerContinueConnetClient(String Name){
		return hm.get(Name);
	}
